...
<div class="row" id="header_nav">
    ...
    <div class="col-md-2 text-center">
        <button type="button" class="btn btn-link" data-toggle="modal" data-target=".login-modal">Login/Registeren</button>
            <!--^^hier is de button voor de Login form-->
