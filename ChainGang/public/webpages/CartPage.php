...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 row">
            ...
            <a href="OrderPage.php" type="button" class="btn btn-primary btn-lg col-lg-6"><b><i>Bestel</i></b></a>
        </div>
    </div>
    <?php
    }
    ...
    {
        echo "<h2>Er zijn nog geen fietsen in het winkelwagentje. <a href='CategoriePage.php'>Shop nu!</a></h2>";
    }
    ?>
